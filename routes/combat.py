...
def combat_version():
    ...
    return jsonify({'version': '2026-03-05-v11', 'features': ['default_skills', 'ghost_fix', 'current_question', 'fix_skills', 'auto_advance_timeout', 'anti_cheat_v2', 'ping_timeout_60', 'socketio_emit_answer', 'monkey_patch', 'rest_submit', 'rest_scope_fix', 'visual_upgrade_v1', 'hq_tiles_v2', 'solid_terrain', 'shadows', 'sprite_fix']})
