...
class User(UserMixin, db.Model):
    ...
    has_seen_tour = db.Column(db.Boolean, default=False)  # Tour d'aide vu
    onboarding_dismissed = db.Column(db.Boolean, default=False)  # Checklist « 3 étapes » fermée manuellement
