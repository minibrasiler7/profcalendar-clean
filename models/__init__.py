...
from models.user_preferences import UserPreferences, UserSanctionPreferences, DashboardTask, DashboardLink
...
__all__ = ['User', 'Holiday', 'Break', 'Classroom', 'Schedule', 'Planning',
           ...
           'ClassroomAccessCode', 'StudentFileShare', 'MixedGroup', 'MixedGroupStudent', 'UserPreferences', 'UserSanctionPreferences', 'DashboardTask', 'DashboardLink',
