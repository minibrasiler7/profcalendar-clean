...
def load_user(user_id):
    ...
    try:
        ...
        # Session corrompue ou user_id invalide — retourner None
        # pour que Flask-Login traite l'utilisateur comme non-authentifié
        print(f"⚠️ Erreur load_user({user_id}): {e}")
        return None
